...
export default function TermsOfService() {
 ...
 <h1 className="text-3xl sm:text-4xl font-bold text-text-primary tracking-tight mb-8">Terms of Service</h1>
 <p className="text-sm text-text-secondary">Last Updated: February 25, 2026</p>

 <section className="mt-8 space-y-4">
 <h2 className="text-xl sm:text-2xl font-semibold text-text-primary">1. Agreement to Terms</h2>
 <p>
 ...
 <section className="mt-8 space-y-4">
 <h2 className="text-xl sm:text-2xl font-semibold text-text-primary">2. Description of Service</h2>
 <p>
 ...
 <section className="mt-8 space-y-4">
 <h2 className="text-xl sm:text-2xl font-semibold text-text-primary">3. User Responsibilities</h2>
 ...
 <section className="mt-8 space-y-4">
 <h2 className="text-xl sm:text-2xl font-semibold text-text-primary">4. Prohibited Uses</h2>
 <p>
 ...
 <section className="mt-8 space-y-4">
 <h2 className="text-xl sm:text-2xl font-semibold text-text-primary">5. &quot;As-Is&quot; Software and Disclaimer of Warranties</h2>
 <p>
 ...
 <section className="mt-8 space-y-4">
 <h2 className="text-xl sm:text-2xl font-semibold text-text-primary">6. Limitation of Liability</h2>
 <p>
 ...
 <section className="mt-8 space-y-4">
 <h2 className="text-xl sm:text-2xl font-semibold text-text-primary">7. Service Availability</h2>
 <p>
