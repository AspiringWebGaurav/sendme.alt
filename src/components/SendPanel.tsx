        ...
        <div className="h-full w-full flex flex-col items-center justify-center p-4 sm:p-8 lg:p-12 relative overflow-y-auto">
            ...
            <div className="w-full max-w-md mx-auto flex flex-col items-center justify-center gap-4 sm:gap-8 mt-10 sm:mt-8">
                {state === 'idle' || state === 'error' ? (
                    <div className="w-full flex flex-col items-center gap-4 sm:gap-6">
                        ...
                        {file && (
                            <button
                                ...
                                className="w-full max-w-[200px] py-3 rounded-xl bg-accent-primary hover:bg-accent-hover focus:ring-4 focus:ring-accent-primary/20 dark:bg-primary dark:hover:bg-primary-dark text-white font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_20px_rgba(108,71,255,0.2)] dark:shadow-[0_0_20px_rgba(139,92,246,0.2)]"
                            >
                    ...
                    <div className="w-full flex flex-col items-center gap-4 sm:gap-6">
                        <div className="w-full bg-bg-surface dark:bg-zinc-900/50 border border-border-subtle dark:border-white/10 p-3 sm:p-4 rounded-xl flex items-center gap-3 sm:gap-4 shadow-sm dark:shadow-none">
                            ...
                            <div className="overflow-hidden min-w-0">
                                <p className="text-[15px] font-medium text-text-primary dark:text-zinc-100 truncate">{file?.name}</p>
                                <p className="text-[13px] text-text-muted dark:text-zinc-400">{file ? (file.size / 1024 / 1024).toFixed(2) : 0} MB</p>
                            </div>
                        </div>
