        ...
        <div className="w-full h-[100dvh] flex flex-col bg-zinc-950 text-zinc-50 overflow-hidden font-sans selection:bg-zinc-800">
            ...
            <main className="flex-1 w-full flex flex-col items-center px-5 pt-8 pb-3 relative z-10 overflow-y-auto">
                <div className="w-full flex flex-col items-center text-center mb-8">
                    ...
                    >
                        <Link href="/transfer?mode=send" className="flex items-center justify-center gap-2 px-6 py-3.5 bg-white active:bg-zinc-200 text-zinc-950 rounded-full font-semibold transition-colors w-full">
                            Send File
                            <ArrowRight className="w-4 h-4" />
                        </Link>
                        <Link href="/transfer?mode=receive" className="flex items-center justify-center gap-2 px-6 py-3.5 bg-zinc-900 border border-zinc-800 active:bg-zinc-800 text-white rounded-full font-semibold transition-colors w-full">
                            Receive File
                        </Link>
                    </motion.div>
                </div>
            ...
            <footer className="w-full flex flex-col items-center gap-3 px-5 py-5 shrink-0 border-t border-zinc-900 relative z-10 bg-zinc-950">
                <div className="flex items-center justify-center gap-6">
                    <Link href="/legal/privacy" target="_blank" rel="noopener noreferrer" className="text-[11px] text-zinc-600 active:text-white transition-colors">Privacy</Link>
                    <Link href="/legal/terms" target="_blank" rel="noopener noreferrer" className="text-[11px] text-zinc-600 active:text-white transition-colors">Terms</Link>
                    <Link href="/legal/aup" target="_blank" rel="noopener noreferrer" className="text-[11px] text-zinc-600 active:text-white transition-colors">Acceptable Use</Link>
                </div>
