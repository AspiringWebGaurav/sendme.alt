...
export function ModeToggle({ mode, onChange }: ModeToggleProps) {
 ...
 className={`relative flex items-center gap-2 px-6 py-2 text-sm font-medium rounded-full transition-colors ${mode === 'send' ? 'text-text-primary' : 'text-text-secondary hover:text-text-primary'
 }`}
 >
 {mode === 'send' && (
 <motion.div
 ...
 className={`relative flex items-center gap-2 px-6 py-2 text-sm font-medium rounded-full transition-colors ${mode === 'receive' ? 'text-text-primary' : 'text-text-secondary hover:text-text-primary'
 }`}
 >
 {mode === 'receive' && (
 <motion.div
